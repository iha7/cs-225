...
//       //   typename BinaryTree<T>::Node* topNode = pop();
//       //   stack.push(topNode->right);
//       //   stack.push(topNode);
//       // }
//     //   if (treeNode != NULL && treeNode->left != NULL) {
//     //     typename BinaryTree<T> Node* nextLeft = treeNode->left;
//     //     while(nextLeft != NULL) {
//     //       stack.push(nextLeft);
//     //       nextLeft = nextLeft->left;
//     //     }
//     //   }else if (treeNode != NULL && treeNode->left == NULL && !empty()) {
//     //     typename BinaryTree<T> Node* topNode = pop();
...
#pragma once
	 ...
	 */	
	 typename TreeTraversal<T>::Iterator begin() {
	 //InorderTraversal* inOrdTra = new InorderTraversal(root);
	 return typename TreeTraversal<T>::Iterator(this, root);
	 }
